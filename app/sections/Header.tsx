    ...
    <header className="flex flex-col lg:flex-row justify-between mx-0 my-24 items-center pt-20 lg:pt-24 bg-center xl:mx-[10%] lg:mx-[7%] md:mx-[7%] ">
      ...
      >
        ...
        <div className="relative">
          ...
          >
        Full Stack Devloper specialize In Front End Devloping
          </Badge>
          <p className="mt-2 ">
            I specialize in building WebApps using Asp Dot Net MVC, React, Next.js, and
            JQuery, turning designs into engaging web experiences.
          </p>
        </div>
        <Button asChild variant={"outline"}>
          <Link
            ...
            href={"mailto:your.bhosalepravin40@gmail.com"}
