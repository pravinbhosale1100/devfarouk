...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={` relative z-10 p-4 lg:p-0 w-full sm:w-[90%] lg:w-[40%]  lg:bg-transparent lg:rounded-none rounded-b-lg ${
      ...
      >
        ...
        <div
          className={`  px-0 py-0 lg:px-5 lg:py-7 bg-[#FBEDDD] dark:text-primary-color mr-0 ml-0 ${
